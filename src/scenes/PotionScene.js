...
export class PotionScene extends BaseScene {
  constructor(textures) {
    ...
    if (matchMedia('(max-width: 900px)').matches){composition.scale.set(0.9); composition.position.set(96,54);} composition.addChild(left,right,cauldronBack); this.addChild(composition,this.beams,this.smoke,cauldronFront);
